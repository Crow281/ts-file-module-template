...
import { Application as SchemaInterface } from "./Application";
 ...
 * {@link SchemaInterface Application} and matches its
 * {@link https://json-schema.org/ JSON Schema}.
 * @param {any} data
 * Object we want to check to see if it matches {@link SchemaInterface Application}.
 * @returns {data is SchemaInterface}
 * true if data is confirmed to be a valid instance of
 * type {@link SchemaInterface Application}, false otherwise.
 *
 * If result is false, you may check property {@link validateApplication#errors}
 ...
 * };
 *
 * //If this object is a valid instance of Application.
 * if (validateApplication(obj)) {
 *     //We can use it as the type.
 *     printObject(obj);
 * }
 * ```
 */
declare const validateApplication: {
     ...
     *
     * If your project contains package ajv, then
     * this function will use AJV's interface for them.
     ...
     * };
     *
     * //If this object is NOT a valid instance of Application.
     * if (!validateApplication(obj)) {
     *     //Tell user validation failed.
     *     console.log("Obj is NOT an instance of Application");
     *
     *     //Fetch the list of errors.
     *     const errors = validateApplication.errors;
     *
     *     //Iterate the errors.
